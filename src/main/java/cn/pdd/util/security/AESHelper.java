...
public class AESHelper {
	...
	private final static String TRANSFORMATION_ECB = "AES/ECB/PKCS5Padding";

	private final static String TRANSFORMATION_CBC = "AES/CBC/PKCS5Padding";
	...
	public static void main(String[] args) throws Exception {
		...
		// Key key = new SecretKeySpec(Base64.decodeBase64("q2XLRyWL1RsrhzNK9FkoKg=="),
		// "AES");
		...
		// String a = Base64.encodeBase64String(encrypt("我们".getBytes(),
		// Base64.decodeBase64("q2XLRyWL1RsrhzNK9FkoKg=="), s.getBytes()));
		// System.out.println(a);

		// byte[] a = decrypt(Base64.decodeBase64("IPNUhArru+Mz6pJ31aVN/A=="),
		// Base64.decodeBase64("q2XLRyWL1RsrhzNK9FkoKg=="), s.getBytes());
